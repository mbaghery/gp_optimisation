...
scratch="/scratch/$USER/stark-"$noFeatures"D_"$A0_1"_"$omega1"_"$FWHM1
results="/data2/finite/mbaghery/stark-"$noFeatures"D_"$A0_1"_"$omega1"_"$FWHM1
...
# 2)  Actual Work
matlab.R2015b -nodisplay -singleCompThread -r "cd $scratch; noFeatures=$noFeatures, mainParallelStark; quit"
